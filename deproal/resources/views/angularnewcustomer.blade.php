...
<div class="form-floating">
    <form class="form-floating">
        ...
        <div class="form-floating mb-3">
            <input type="number" class="form-control" id="txtDebt" ng-model="customer.debt">
        ...
        <div class="d-grid gap-2">
            <button class="btn btn-success" type="button" ng-click="addCustomer()">Registrar Cliente</button>
        </div>
    </form>
</div>
</div>
